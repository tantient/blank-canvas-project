import imgExterior1 from "@/assets/gallery/zenova-exterior-01.jpg.asset.json";
import imgExterior2 from "@/assets/gallery/zenova-exterior-02.jpg.asset.json";
import imgDeck from "@/assets/gallery/zenova-deck-sunset-01.jpg.asset.json";
import imgDining from "@/assets/gallery/zenova-dining-panorama-01.jpg.asset.json";
import imgSpa from "@/assets/gallery/zenova-spa-room-01.jpg.asset.json";
import imgCabin from "@/assets/gallery/zenova-suite-01.jpg.asset.json";
...
export const itineraries: Itinerary[] = [
  {
    ...
    hero: imgExterior1.url,
    images: [imgDining.url, imgCabin.url, imgDeck.url],
    includesVi: [
  ...
  },
  {
    ...
    hero: imgExterior2.url,
    images: [imgDeck.url, imgSpa.url, imgCabin.url],
    includesVi: [
  ...
  },
  {
    ...
    hero: imgDeck.url,
    images: [imgExterior1.url, imgDining.url],
    includesVi: [
