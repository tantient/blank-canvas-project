        ...
        <div className={`grid lg:grid-cols-2 ${flip ? "lg:[&>*:first-child]:order-2" : ""}`}>
          ...
          <div className="p-8 lg:p-10">
            ...
            <div className="mb-6 border-t border-zenova-ink/10 pt-5">
              <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-zenova-ink">
                {t.offers.terms}
              </p>
            ...
            <Button
              asChild
              className="btn-sheen rounded-none bg-zenova-gold px-6 text-[11px] font-semibold uppercase tracking-[0.18em] text-zenova-ink hover:bg-zenova-gold/90"
            >
              <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer">
                {t.offers.cta}
              </a>
