    ...
    <div className="grid gap-8 lg:grid-cols-[1.3fr_1fr] lg:items-center">
      <div>
        <div className="relative aspect-[4/3] w-full touch-manipulation rounded-sm border border-zenova-ink/15 bg-zenova-ink/[0.04] p-2">
          {zones.map((z, i) => {
            ...
            const button = (
              ...
              >
                <span className="line-clamp-3 text-[10px] uppercase leading-tight tracking-[0.18em] text-zenova-ink">
                  {label(z)}
                </span>
              </button>
            );
        ...
        >
          {active ? (
            <>
              <p className="text-[10px] uppercase tracking-[0.24em] text-zenova-gold">
                {vi ? "KHU VỰC" : "AREA"}
              </p>
