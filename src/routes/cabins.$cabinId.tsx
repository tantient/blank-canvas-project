...
import { CabinDetailPage } from "@/components/gallery/CabinDetailPage";
import { cabinTypes } from "@/components/gallery/cabins-data";
...
export const Route = createFileRoute("/cabins/$cabinId")({
  loader: ({ params }) => {
    const cabin = cabinTypes.find((c) => c.id === params.cabinId);
